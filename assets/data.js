  ...
  education: [
    {
      ...
      list: ['GPA 3.4 out of 4.0', 'Graduated with Second Class Honor'],
    },
    {
      position: 'Researcher',
      ...
      list: ['Conducted a <i>Simple Fighting Game by Character View Image Analysis</i> research using Unity Game Engine.'],
    },
  ],
  activity: [
    {
      ...
      endDate: 'Aug 2016',
      link: 'https://www.tuat.ac.jp',
      description: ['Selected as a recipient of JASSO Scholarship to participate in a research at Tokyo University.'],
    },
    {
  ...
  project: {
    personal: [
      ...
      },
      {
        ...
        tag: ['go', 'postgresql', 'nodejs', 'react', 'docker', 'kubernetes'],
      },
    ],
    work: [
      {
      ...
      },
      {
        ...
        link: 'https://mola.tv/',
        tag: ['go', 'mysql', 'redis', 'nsq', 'docker', 'kubernetes'],
      },
      {
        name: 'E-mas',
        description: 'An online mobile application for buying, selling, and withdrawing digital gold.',
        link: 'http://e-mas.com',
        tag: ['go', 'beego', 'mysql', 'redis', 'elasticsearch', 'kibana', 'rabbitmq'],
      },
      {
        name: 'Skrap',
        description:
