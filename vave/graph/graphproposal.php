...
while($row = mysqli_fetch_assoc($selectResult)) {
    if($currentModel != $row['model']){
        ...
        $selectSql2 = "SELECT * FROM vave where model='$currentModel' order by manufacturerNo";
...
<script type=\"text/javascript\">
    ...
    function drawChart() {
        ...
        var options = {
            title: 'Total Number of Proposal',
        ...
        var chart = new google.visualization.ColumnChart(document.getElementById('graphproposal'));
